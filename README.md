...
## Rust & TypeScript Prerequisites

| Proof of work | Description | Technologies |
| --- | --- | --- |
| [Rust_Prerequisites_Tutorial.pdf](week-0/Rust_Prerequisites_Tutorial.pdf) | Rust prerequisites tutorial | Rust |
| [TS_Prerequisites_Tutorial.docx.pdf](week-0/TS_Prerequisites_Tutorial.docx.pdf) | TypeScript prerequisites tutorial | TypeScript |
| [airdrop](week-0/airdrop/) | Basic Solana program for airdropping tokens | Typescript |
| [airdrop2](week-0/airdrop2/) | Enhanced airdrop functionality in Rust | Rust, Solana |
